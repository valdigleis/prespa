...
print(">>>> Prespa Algorithm")

# Experimenter (my Algorithms)
pM01 = denoise_salt(M01)
pM02 = denoise_salt(M02)
pM03 = denoise_salt(M03)
pM04 = denoise_salt(M04)
pM05 = denoise_salt(M05)
pM06 = denoise_salt(M06)
pM07 = denoise_salt(M07)
pM08 = denoise_salt(M08)
...
rP[0, 1] = psnr(F01, bM01)
rP[1, 1] = psnr(F02, bM02)
rP[2, 1] = psnr(F03, bM03)
rP[3, 1] = psnr(F04, bM04)
rP[4, 1] = psnr(F05, bM05)
rP[5, 1] = psnr(F06, bM06)
rP[6, 1] = psnr(F07, bM07)
rP[7, 1] = psnr(F08, bM08)

rP[0, 2] = psnr(F01, nM01)
rP[1, 2] = psnr(F02, nM02)
rP[2, 2] = psnr(F03, nM03)
rP[3, 2] = psnr(F04, nM04)
rP[4, 2] = psnr(F05, nM05)
rP[5, 2] = psnr(F06, nM06)
rP[6, 2] = psnr(F07, nM07)
rP[7, 2] = psnr(F08, nM08)

rP[0, 3] = psnr(F01, wM01)
rP[1, 3] = psnr(F02, wM02)
rP[2, 3] = psnr(F03, wM03)
rP[3, 3] = psnr(F04, wM04)
rP[4, 3] = psnr(F05, wM05)
rP[5, 3] = psnr(F06, wM06)
rP[6, 3] = psnr(F07, wM07)
rP[7, 3] = psnr(F08, wM08)
...
rE[0, 1] = nrmse(F01, bM01)
rE[1, 1] = nrmse(F02, bM02)
rE[2, 1] = nrmse(F03, bM03)
rE[3, 1] = nrmse(F04, bM04)
rE[4, 1] = nrmse(F05, bM05)
rE[5, 1] = nrmse(F06, bM06)
rE[6, 1] = nrmse(F07, bM07)
rE[7, 1] = nrmse(F08, bM08)

rE[0, 2] = nrmse(F01, nM01)
rE[1, 2] = nrmse(F02, nM02)
rE[2, 2] = nrmse(F03, nM03)
rE[3, 2] = nrmse(F04, nM04)
rE[4, 2] = nrmse(F05, nM05)
rE[5, 2] = nrmse(F06, nM06)
rE[6, 2] = nrmse(F07, nM07)
rE[7, 2] = nrmse(F08, nM08)

rE[0, 3] = nrmse(F01, wM01)
rE[1, 3] = nrmse(F02, wM02)
rE[2, 3] = nrmse(F03, wM03)
rE[3, 3] = nrmse(F04, wM04)
rE[4, 3] = nrmse(F05, wM05)
rE[5, 3] = nrmse(F06, wM06)
rE[6, 3] = nrmse(F07, wM07)
rE[7, 3] = nrmse(F08, wM08)
